...
//In this project try_catch block have same alert. because there are RPC delay issue in solana devnet so every time it's show fail transaction alert in UI 
  //so i set default alert in try or catch. this is in only demo project and in paid node / mainnet it problem will not show because there are fast RPC.
