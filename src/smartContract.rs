// Deployed smart contract code on solana playgorund for back up.(If at any time there is a Devnet update)


use anchor_lang::prelude::*;

declare_id!("Arp1b8XkZ2btv3NmvT5ANMxZ3dzo9dnGK2E28Fq2Mjuj");
